  ...
  return (
    <>
      <div className="box homepage">
        ...
        <hr />
        <div className="">
          <div className="income">Income<span className='fs-4 text-success'>{income} VNĐ</span></div>
          <div className="balance">Balance<span className='fs-4 text-primary'>{balance} VNĐ</span></div>
          <div className="expense">Expense<span className='fs-4 text-danger'>{totalExpense} VNĐ</span></div>
        </div>
        <hr />
        <ExpenseItem />
        <hr />
